...
if TYPE_CHECKING:
    ...
    VLLM_QWEN4_PLE_MMAP: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Local GB10 Qwen4Exp PLE row lookup from checkpoint files (eager TP1).
    "VLLM_QWEN4_PLE_MMAP": lambda: os.getenv("VLLM_QWEN4_PLE_MMAP", "0") == "1",
